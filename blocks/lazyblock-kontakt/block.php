<section class="contact grid">
    ...
    <form id="contact-form" class="contact__form" action="#">
        ...
        <div class="dsgvo-wrapper"><label class="dsgvo" for="dsgvo">Bevor ihr fragt, ja ich habe die <a href="<?php echo esc_url($attributes['link']); ?>" tabindex="0">Datenschutzerklärung</a> gelesen und bin mit der Verarbeitung meiner personenbezogenen Daten einverstanden, deshalb setze ich hier mein Häkchen: <input type="checkbox" id="dsgvo" name="dsgvo" required tabindex="0"><span class="checkmark"></span></label></div>
