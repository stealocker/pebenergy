<section class="contact grid">
    ...
    <form id="contact-form" class="contact__form" action="#">
        <p>Hallo, mein Name ist <label for="name"></label><input type="text" id="name" name="name" required> und Sie erreichen mich unter<label for="email"></label>
            <input type="email" id="email" name="email">. Ich komme mit folgendem Anliegen zu Ihnen:<label for="inquiry"></label>
            ...
            </select></span>. Vielleicht können Sie mir hierbei helfen:
        </p>
        <label for="message"></label>
        <textarea id="message" name="message" rows="5"></textarea>
        <div class="dsgvo-wrapper"><label class="dsgvo" for="dsgvo">Bevor Sie fragen, ja ich habe die <a href="<?php echo esc_url($attributes['link']); ?>" tabindex="0">Datenschutzerklärung</a> gelesen und bin mit der Verarbeitung meiner personenbezogenen Daten einverstanden, deshalb setze ich hier mein Häkchen: <input type="checkbox" id="dsgvo" name="dsgvo" required tabindex="0"><span class="checkmark"></span></label></div>
